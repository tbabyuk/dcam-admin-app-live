                ...
                <tbody>
                    {teacherAttendance?.map((student, index) => (
                        <tr key={index} className="even:bg-gray-300">
                            ...
                            <td className={`py-2 px-3 sm:px-6 ${student.attendance.week1 === "present" ? "text-green-600" : student.attendance.week1 === "counted" ? "text-orange-600" : "text-red-600"}`}>${(student.attendance.week1 === "present" || student.attendance.week1 === "counted" ? (student.week1Pay ?? 0) : 0).toFixed(2)}</td>
                            ...
                            <td className={`py-2 px-3 sm:px-6 ${student.attendance.week2 === "present" ? "text-green-600" : student.attendance.week2 === "counted" ? "text-orange-600" : "text-red-600"}`}>${(student.attendance.week2 === "present" || student.attendance.week2 === "counted" ? (student.week2Pay ?? 0) : 0).toFixed(2)}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
